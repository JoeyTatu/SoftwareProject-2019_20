       ...
       <!-- Main jumbotron for a primary marketing message or call to action -->
        ...
        <table>
                <tr>
                    <th width="100%">
                        <center>
                            <h2><img src="../img/events/events-header.jpg" width="50%" alt="Events"/></h2>
                            <p>
                            This section is for creating and searching events.
                            </p>
                            <hr />
                        </center>
                    </th>
                ...
                <tr>
                    <td  width="50%">
                        <center>
                            <p><a class="btn btn-secondary" href="../htmlEvents/createEvent.php" role="button">Create Event</a></p>
                        </center>
                    </td>
                    <td>
                    </td>
                ...
                <tr>
                    <td  width="50%">
                        <center>
                            <p><a class="btn btn-secondary" href="../htmlEvents/eventsOptions.php" role="button">Search Events</a></p>
                        </center>
                    </td>
                    <td>
                    </td>
